...
int isReservedWord() {
    ...
    else if(!strcmp(lexeme, "inicio") || !strcmp(lexeme, "in�cio"))
    ...
    else if(!strcmp(lexeme, "entao") || !strcmp(lexeme, "ent�o"))
        tokenTemp = ENTAO_CODE;

    else if(!strcmp(lexeme, "senao") || !strcmp(lexeme, "sen�o"))
    ...
    else if(!strcmp(lexeme, "faca") || !strcmp(lexeme, "fa�a"))
        tokenTemp = FACA_CODE;

    else if(!strcmp(lexeme, "repita"))
        tokenTemp = REPITA_CODE;

    else if(!strcmp(lexeme, "ate") || !strcmp(lexeme, "at�"))
        tokenTemp = ATE_CODE;
...
void resultadoSintaxe() {
    ...
    if(nextToken != token) {
        printf("\nErro de sintaxe detectado! C�digo do erro %d\n", token);
        if(tokenOK == -1) {
            switch(token) {
                case -DOT:
                    printf("Era esperado \".\" ap�s o lexema \"fim\"!\n");
                break;
                ...
                case -RIGHT_PAREN:
                    printf("Est� faltando parenteses a direita!\n");
                break;

                case -LEFT_PAREN:
                    printf("Est� sobrando parenteses a direita!\n");
                break;

                case -FIM_CODE:
                    printf("Est� sobrando lexema \"fim\"!\n");
                break;

                case -MOD_OP:
                    printf("Opera��o de resto � inv�lida para a express�o definida!\n");
                break;

                case -LOGICA_CODE:
                    printf("Erro na constru��o do bloco de opera��es l�gicas\n");
                break;

                case -SENAO_CODE:
                    printf("O lexema \"senao\" precisa vir logo ap�s o t�rmino de uma opera��o \"se\" anterior!\n");
                break;

                case -ATE_CODE:
                    printf("O lexema \"ate\" precisa vir depois de um lexema \"repita\" anterior e um conjunto de instru��es intermedi�rias!\n");
                break;
                ...
                case -CASO_CODE:
                    printf("Erro na estrutura��o da fun��o \"caso\"!\n");
                break;

                case -UNKNOWN:
                    printf("Erro desconhecido! Ainda existem fun��es na pilha ap�s o t�rmino na an�lise!\n");
                break;
        ...
        if(tokenOK == 0)
            printf("O lexema \"%s\" com token %d n�o pode vir depois de um lexema com token %d\n", lexeme, nextToken, (-token));
    } else
        printf("\nC�digo completamente verificado!\n");
}
